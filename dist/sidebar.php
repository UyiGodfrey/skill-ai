                ...
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            ...
                            <span style="font-size:16px; color:#1D4DA1;"><?php echo "Welcome back ". $_SESSION['username']; ?><span>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        <?php if($_SESSION['isadmin'] == 1) {
                                echo  "<li class='sidebar-title'>Administrator</li>";
                        }else{
                                 echo  "<li class='sidebar-title'>Hostel Manager</li>";
...
<!-- 
                        ...
                        <li class="sidebar-item  ">
                            <a href="add_room.php" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  ">
                            <a href="allocated_room.php" class='sidebar-link'>
                                <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                                <span>Allocated Building</span>
                            </a>
                        </li>
                        <li class="sidebar-item  ">
                            <a href="admin_chat.php" class='sidebar-link'>
                                <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                                <span>ChatBot</span>
                            </a>
                        </li>
